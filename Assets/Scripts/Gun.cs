...
public class Gun : MonoBehaviour
{
    ...
    public void Shoot()
    {
        ...
        // One recoil coroutine at a time
    ...
    // Push gun back then return (position‑based recoil)
    IEnumerator Recoil()
    {
        Vector3 recoilTarget = initialPosition + new Vector3(0f, 0f, -recoilDistance);
        float t = 0f;

        // Move initial → recoil target
        while (t < 1f)
        {
        ...
        // Snap to initial to avoid drift
